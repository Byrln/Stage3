      ...
      >
        {isHorizontal ? (
          <>
            ...
            <div className="flex h-[10%] items-start justify-center pt-1">
              {labelEl}
            </div>
          </>
        ) : (
          <>
            <div className="flex w-[10%] items-center justify-end pr-2">
              {valueEl}
            </div>
            <div className="flex flex-1 items-center justify-center">
              {pctEl}
            </div>
            <div className="flex w-[10%] items-center justify-start pl-2">
              {labelEl}
            </div>
          </>
        )}
