  ...
  return (
    <main className="space-y-4">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h1 className="font-heading text-xl tracking-tight text-neutral-50">Analytics</h1>
          <p className="mt-1 text-xs text-neutral-400">
            Visualize revenue, bookings, customers, and occupancy trends.
          </p>
        </div>
      </header>
